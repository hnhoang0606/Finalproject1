...
/** @brief Function display a Employee object from of the list inside DeptLocationsData.
 *  
 *  Function display a DeptLocations object from of the list inside DeptLocationsData.
 */
...
{   
    ...
    cout << "Please enter the name of the folder where you want to copy the data. ";
    cin.ignore();
    getline(cin,folder);
    EmployeeData employeeData("Employee.data");
    employeeData.ExportToFile("employee2.data");
}
